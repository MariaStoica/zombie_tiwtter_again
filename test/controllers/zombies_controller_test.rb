...
class ZombiesControllerTest < ActionController::TestCase
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post :create, zombie: { age: @zombie.age, bio: @zombie.bio, email: @zombie.email, graveyard: @zombie.graveyard, name: @zombie.name, rotting: @zombie.rotting }
    end
  ...
  test "should update zombie" do
    patch :update, id: @zombie, zombie: { age: @zombie.age, bio: @zombie.bio, email: @zombie.email, graveyard: @zombie.graveyard, name: @zombie.name, rotting: @zombie.rotting }
    assert_redirected_to zombie_path(assigns(:zombie))
  end
